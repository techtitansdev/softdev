      ...
      <div className="flex">
        ...
        <div className="flex-col">
          <div className="mx-auto mt-16 flex flex-col-reverse items-center justify-between px-6 pb-10 sm:px-10 lg:flex-row lg:px-12 lg:pt-20 xl:px-20">
            ...
            <div className="w-full items-center justify-center lg:ml-20 lg:w-1/2">
              <img
                src="/tech4all.png"
                alt="project image"
              ...
              <div className="mb-4 mt-1 flex justify-between md:mt-4">
                <p className="text-xs font-medium md:text-sm">Days Left: 10</p>
                <p className=" text-xs font-medium md:text-sm">Goal: ₱20,000</p>
              </div>
            </div>
          </div>
