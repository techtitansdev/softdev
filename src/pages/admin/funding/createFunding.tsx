...
function CreateFunding() {
  ...
  console.log(fundingData.date)
  console.log(project);
  console.log(fundingData.hub);
  return (
    <div>
      <Head>
        <title>Create Project | Global shapers</title>x``
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <Select
                ...
                value={transformedProjects.find((option: { value: string; }) => option.value === fundingData.project)}
