...
const Tech4all = () => {
  return (
    <>
        ...
        <div className="mx-auto lg:max-w-[1200px] xl:max-w-[1230px] ">
          <div className="flex flex-col-reverse items-center sm:pt-16 lg:flex-row lg:pt-28 ">
            <div className="w-full flex-col items-center justify-center lg:w-1/2">
              ...
              <p className="mb-2 px-4 pr-14 text-xs font-light text-gray-800 sm:max-w-[700px] sm:px-6 sm:text-base md:max-w-[750px] lg:max-w-[530px] xl:px-0 xl:text-lg">
              ...
              <p className="mb-32 px-4 text-xs font-light text-gray-800 sm:px-6 sm:text-base md:mb-44 md:max-w-[530px] lg:mb-0 lg:text-lg xl:px-0">
                Connect with us:
                <Link
      ...
      <div className="mt-12 flex items-center justify-center text-2xl font-medium text-[#227135] sm:text-3xl lg:mt-24 xl:text-4xl">
        Project Objectives
      </div>
      ...
      <div className="mx-auto mb-12 grid  max-w-[1300px] grid-cols-1 gap-4 lg:mb-24 lg:grid-cols-2">
        <div className="flex items-center justify-center">
          ...
          <div className="ml-1 lg:ml-4">
            ...
            <div className="max-w-[420px] pr-2 text-xs font-light sm:text-sm xl:text-base">
