  ...
  create: protectedProcedure
    ...
    .mutation(async (opts) => {
      ...
      const newAbout = {
        ...
        theme: input.theme,
        projectImageId: input.projectImageId,
        objectiveImageId: input.objectiveImageId,
        projectName1ImageId: input.projectName1ImageId,
        projectName2ImageId: input.projectName2ImageId,
      };
